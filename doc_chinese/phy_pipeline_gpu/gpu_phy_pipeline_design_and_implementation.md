...
| **P2** | ✅ **离线判据全过**（`3df49a6d3b`：提取与权重**一次提交**；235/235 dump 逐字节不变、提交数 3.00 → **2.00**、中途间隔系列为空，见 §5.8.7）；**⏳ 空口腿待跑**（头条：`cbs/lane` 3.00 → ≈2.00）|
| P3 | ⏳ 未开始；形状仍待 §5.8.5 P0-(b) 的选项 1/2 决策（要一条 `burst` 序的腿量跨 slot 并行损失）|
