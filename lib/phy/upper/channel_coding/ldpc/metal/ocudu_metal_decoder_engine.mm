...
#include "ocudu_nms_flooding_decoder_metal_source.h" // generated by CMake (embedded .metal source)
#include "ocudu_nms_async_decoder_metal_source.h"    // generated by CMake (embedded .metal source)
                          ...
                          algo mode, bool et_enabled)
{
  ...
  NSError*       error   = nil;
  const char*    src_bytes = (mode == algo::flooding)    ? (const char*)ocudu_nms_flooding_decoder_metal_source
                           : (mode == algo::async_delta) ? (const char*)ocudu_nms_async_decoder_metal_source
                                                         : (const char*)ocudu_nms_layered_decoder_metal_source;
