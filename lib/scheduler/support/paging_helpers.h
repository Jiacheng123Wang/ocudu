...
private:
  ...
  std::array<slot_point, MAX_NOF_SSB_CANDIDATES> type0_pdcch_css_slots;
  ...
  std::array<static_vector<slot_point, pcch_config::MAX_PO_PER_PF>, MAX_NOF_SSB_CANDIDATES> type2_pdcch_css_slots;
