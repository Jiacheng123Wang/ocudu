...
{
  node["phy_pipeline"]                             = config.phy_pipeline;
  node["device_resource_grid"]                     = config.device_resource_grid;
  ...
  node["pusch_channel_estimator_helena_model_path"] = config.pusch_channel_estimator_helena_model_path;
  ...
  node["pusch_channel_equalizer_backend"]          = config.pusch_channel_equalizer_backend;
