// “全量链接”法
// g++ -o check_ldpc check_ldpc_z384.cpp -I./include -I./build/include -I./external/fmt/include -Wl,--start-group $(find ./build/lib -name "*.a") ./build/external/fmt/libfmt.a -Wl,--end-group -lpthread -lm
...
int main() {
    ...
    */
    ...
    std::ifstream infile("input_z384.txt");
    if (!infile.is_open()) {
    ...
    printf("📥 srsRAN Loaded %d bytes from input_z384.txt\n", byte_idx);
