...
| **14** | **★ 下一件事：让上层 PHY 的 PUCCH/SRS 任务【拥有】自己槽的网格与 PDU**（现在 `[this, &pdu]` 读按槽复用的状态 ⇒ 一"等"就跨槽）| **可离线判**（`uplink_processor` 的单测）| ⬜ **下一步** |
...
**七条腿揭出七个缺陷，其中六个已修**（第七个不是 D1 的：**上层 PHY 的 PUCCH/SRS 任务读"按槽复用"的状态**，
